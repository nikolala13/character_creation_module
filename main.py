...
def attack(char_name: str, char_class: str) -> str:
    """Функция расчета наносимого урона зависящего от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция рассчета блокированного урона зависящего от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция специального умения для каждого класса"""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция проверки работоспособности предыдущих функций."""
    if char_class == 'warrior':
